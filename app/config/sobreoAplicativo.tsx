      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.paragraphContainer}>
          <Text style={styles.paragraph}>
            O Sabores Caseiros é o seu aplicativo de receitas prático e intuitivo. Aqui você encontra receitas detalhadas com imagens, ingredientes e passo a passo para preparar desde pratos simples até refeições especiais.
          </Text>
          <Text style={styles.paragraph}>
            Salve suas receitas favoritas, compartilhe novas criações e explore sugestões da comunidade. Com o Sabores Caseiros, cozinhar se torna uma experiência colaborativa e deliciosa!
          </Text>
        </View>
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoText}>
            Desenvolvido com React Native e Expo, garantindo performance e compatibilidade entre iOS e Android. Aproveite o Sabores Caseiros e transforme sua cozinha em um verdadeiro laboratório de sabores!
          </Text>
        </View>
        ...
        <View style={styles.banner}>
          <Text style={styles.bannerText}>
            Descubra o prazer de cozinhar com o Sabores Caseiros
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
